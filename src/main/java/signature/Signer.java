...
public class Signer {
    ...
    final static String  firmasDigitales = "src/main/java/signature/firmas-digitales.txt";

    public static void main(String[] args) throws Exception {
        String inputDirectoryPath = "src/main/java/signature/archivos"; // Cambia esto por la ruta del directorio que deseas recorrer
    ...
    public static void generateSignaturesFile(File archivo ) throws NoSuchAlgorithmException, IOException, SignatureException, InvalidKeyException {
        ...
        appendToFile(firmasDigitales, certificado);
